# Code adapted from https://github.com/cda-tum/mqt-bench/blob/main/src/mqt/bench/benchmarks/qpeinexact.py
...
def qpe_circuit(num_qubits: int) -> QuantumCircuit:
